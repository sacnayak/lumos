...
public class DataProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://edu.cmu.ssnayak.lumos.provider/messages");
    public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://edu.cmu.ssnayak.lumos.provider/profile");
    ...
    static {
        ...
        uriMatcher.addURI("edu.cmu.ssnayak.lumos.provider", "messages", MESSAGES_ALLROWS);
        uriMatcher.addURI("edu.cmu.ssnayak.lumos.provider", "messages/#", MESSAGES_SINGLE_ROW);
        uriMatcher.addURI("edu.cmu.ssnayak.lumos.provider", "profile", PROFILE_ALLROWS);
        uriMatcher.addURI("edu.cmu.ssnayak.lumos.provider", "profile/#", PROFILE_SINGLE_ROW);
    }

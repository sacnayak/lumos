...
public class GcmUtil {
	        ...
	        protected Boolean doInBackground(Void... params) {
	            ...
	            for (int i = 1; i <= MAX_ATTEMPTS; i++) {
		            ...
		            try {
		                ...
		                //String regid = gcm.register(Commons.getSenderId());
						String regid = gcm.register("636712503528");
		                // You should send the registration ID to your server over HTTP,
		                // so it can use GCM/HTTP or CCS to send messages to your app.
		                ServerUtilities.register(Commons.getPreferredEmail(), regid);
	...
	private void broadcastStatus(boolean status) {
    	Intent intent = new Intent(Commons.ACTION_REGISTER);
